...
//	  file1
       ...
       if(strcmp(str4,"XXXX"))
	{
     ...
     while(!strcmp(entry,"release") || !strcmp(entry,"r"))
     {
       if(!strcmp(str4,"XXXX"))
	 {
	 cout << "********Error no table in use" << endl;
	 cout << endl << "> ";
	 getstring(entry,MAXSTR);
	 strcpy(str5,entry);
	 check(str5,entry,str5);
  ...
  while(!strcmp(entry,"delete") || !strcmp(entry,"del") || !strcmp(entry,"undelete") || !strcmp(entry,"un"))
  {
   ...
   int sum=0,num=0,index=0,temp1=0;
...
//   sum = sum + 10;
   ...
   if(!strcmp(str4,"XXXX"))
   ...
   else
    {
     ...
     if(num > k || num == 0)
      {
       cout << "Error!!Incompatable number." << endl;
       cout << endl << str4 << "> ";
       getstring(entry,MAXSTR);
       strcpy(str5,entry);
       check(str5,entry,str5);
...
//      sum = sum/10;
	...
	{
	 get_data(str3,strarr,strarr1);
	 cout << endl << "Do you want to add(y/n): ";
	 cin >> ch;
	 cin.get();
	}
...
//   cout << "\n**************************************************\n";
   cout << "  Field name          Field Type        Field Size\n";
//   cout << "\n**************************************************\n";
